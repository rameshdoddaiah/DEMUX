...
from ..sampling.segment import MatrixProfileSegmentation, WindowSegmentation
...
class LimeTS(LimeBase):
    ...
    def __init__(self,
        ...
        segmenter = MatrixProfileSegmentation(partitions, win_length)
        # segmenter = WindowSegmentation(partitions=partitions)
